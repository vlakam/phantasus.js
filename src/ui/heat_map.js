  ...
  options = $
    .extend(
      ...
      menu: {
        ...
        Tools: ['New Heat Map', null, 'Hierarchical Clustering', null, 'Marker Selection', 'Nearest Neighbors', 'Adjust', 'Collapse', 'Create Calculated Annotation', 'Similarity Matrix', 'Transpose', 't-SNE', null, 'Chart', null, 'Sort', 'Filter', null, 'API', null, 'k-means', 'limma', 'PCA Plot'],
...
phantasus.HeatMap.prototype = {
  ...
  updateDataset: function () {
    ...
    this.heatmap.getColumnPositions().setSpaces(phantasus.HeatMap.createGroupBySpaces(dataset, this.project.getGroupColumns(), this.columnGapSize, true));
    this.trigger('change', {
      name: 'updateDataset',
      source: this,
      arguments: arguments
